...
var ProfileActions = _reflux2["default"].createActions(["updateAge"]);

exports["default"] = ProfileActions;
module.exports = exports["default"];

},{"reflux":203}],2:[function(require,module,exports){
'use strict';
...
_reactRouter2['default'].run(require('./routes.jsx'), _reactRouter2['default'].HistoryLocation, function (Handler, state) {
  _react2['default'].render(_react2['default'].createElement(Handler, null), document.body);
});

},{"./routes.jsx":6,"react":202,"react-router":33}],4:[function(require,module,exports){
'use strict';
...
var _storesUsersProfileStoreJsx = require('../../stores/users/ProfileStore.jsx');

var _storesUsersProfileStoreJsx2 = _interopRequireDefault(_storesUsersProfileStoreJsx);

var _actionsUsersProfileActionsJsx = require('../../actions/users/ProfileActions.jsx');

var _actionsUsersProfileActionsJsx2 = _interopRequireDefault(_actionsUsersProfileActionsJsx);

var Profile = _react2['default'].createClass({
  displayName: 'Profile',

  mixins: [_reflux2['default'].connect(_storesUsersProfileStoreJsx2['default'])],
  render: function render() {
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'h2',
        { onClick: _actionsUsersProfileActionsJsx2['default'].updateAge },
        p.age
      )
    );
  }
...
},{"../../actions/users/ProfileActions.jsx":1,"../../stores/users/ProfileStore.jsx":7,"react":202,"react-router":33,"reflux":203}],6:[function(require,module,exports){
'use strict';
...
exports['default'] = _react2['default'].createElement(
  _reactRouter.Route,
  { name: 'app', path: '/', handler: require('./app.jsx') },
  _react2['default'].createElement(_reactRouter.DefaultRoute, { name: '/users/profile', handler: require('./components/users/Profile.jsx') }),
  _react2['default'].createElement(_reactRouter.NotFoundRoute, { handler: require('./components/pages/notFound.jsx') })
);
module.exports = exports['default'];

},{"./app.jsx":2,"./components/pages/notFound.jsx":4,"./components/users/Profile.jsx":5,"react":202,"react-router":33}],7:[function(require,module,exports){
'use strict';
...
var ProfileStore = _reflux2['default'].createStore({
  listenables: [_actionsUsersProfileActionsJsx2['default']],
...
},{"../../actions/users/ProfileActions.jsx":1,"reflux":203}],8:[function(require,module,exports){
...
},{"eventemitter3":204,"native-promise-only":205}]},{},[3]);
